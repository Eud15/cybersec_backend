# Generated by Django 5.2.5 on 2025-12-04 23:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(max_length=200)),
                ('description', models.TextField(blank=True, help_text='Description détaillée du contrôle NIST', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('technique_code', models.CharField(blank=True, help_text='Code unique de la technique (ex: AC-2.1, SI-4.a)', max_length=20, null=True, unique=True)),
                ('nom', models.CharField(max_length=200)),
                ('description', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(max_length=200)),
                ('description', models.TextField()),
                ('mesure_code', models.CharField(blank=True, help_text='Code unique de la mesure (ex: AC-2.1.01, SI-4.a.01)', max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('efficacite', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Efficacité du contrôle contre cette menace (0-100%)', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
